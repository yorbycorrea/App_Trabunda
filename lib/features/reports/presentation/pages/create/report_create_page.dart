...
import 'package:scanner_trabunda/features/reports/presentation/pages/detail/report_detail_page.dart';
...
class _ReportCreatePageState extends State<ReportCreatePage> {
  ...
  // =====================================================
  //   Apoyos por horas (ROL PLANILLERO)
  // =====================================================
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            // ===== SOLO PLANILLERO: acceso rápido a Apoyos por horas =====
            if (isPlanillero) ...[
            ...
            // ===== Sección “Personal por área” (igual que antes) =====
            Row(
              children: [
                const Text(
                  'Personal por área',
...
// Tarjeta para el acceso a "Apoyos por horas" (solo planillero)
